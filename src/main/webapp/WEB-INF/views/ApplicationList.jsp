...
<section>
    ...
    <div class="leftpanel">
        ...
        <div class="leftpanelinner">
            ...
            <ul class="nav nav-pills nav-stacked nav-bracket">
                ...
                <li class="nav-parent nav-active active"><a href=""><i class="fa fa-laptop"></i> <span>Manager Controls</span></a>
    ...
    <div class="mainpanel">
        ...
        <div class="pageheader">
            <h2><i class="fa fa-search"></i> Application Processing</h2>
            <div class="breadcrumb-wrapper">
                <span class="label">You are here:</span>
                <ol class="breadcrumb">
                    <li><a href="/applicationList">Application Processing</a></li>
                    <li class="active">Manager Controls</li>
...
<script>
    ...
    $(document).ready(function() {
        table=  $('#table2').DataTable({
            ...
            "ajax": {
                "url": "application/selectAllWaiting",
                "dataSrc" : '',
                "type" : "POST"
            },
            "columns": [
            ...
            "columnDefs":[
                {"targets": 5,//编辑
                    "data": null,
                    "defaultContent":
                        "<input type='button' class='fa fa-trash-o' id='agree' value='AGREE' onclick='handle(agree)'/>"
                        +"<input type='button' class='fa fa-trash-o' id='reject' value='REJECT' onclick='handle(reject)'/>"
    ...
    function handle(id) {
        var result=$(id).innerText==="AGREE"?1:0;
        alert(result);
        ...
        $.ajax({
            ...
            data:{
                "id": $info[0].innerHTML,
                "application": $info[1].innerHTML,
                "userId": $info[2].innerHTML,
                "requestDate": $info[3].innerHTML,
                "result":result
            },
            success:function (result) {
                if(result.code===400)
