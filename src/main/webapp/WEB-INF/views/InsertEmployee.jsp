...
<section>
    ...
    <div class="mainpanel">
        ...
        <div class="pageheader">
            <h2><i class="fa fa-edit"></i> Add Employee</h2>
        ...
        <div class="panel-body panel-body-nopadding">
            ...
            <form class="form-horizontal form-bordered" id="staff-inf">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="staffName" id="staffName" class="form-control"  onblur="isnull('staffName','warnName')">
                            <p></p>
                    ...
                    <!--年龄-->
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Age<span class="asterisk">*</span></label>
                        <div class="col-sm-9">
                            <input type="text" name="staffAge" id="staffAge" class="form-control" onblur="isnull('staffAge','warnAge')">
                            <p></p>
                    ...
                    <!--性别-->
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Sex<span class="asterisk">*</span></label>
                        <div class="col-sm-9">
                            <select  name="staffSex" class="form-control" id="staffSex">
                            <option value=""></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="staffPhone" name="staffPhone" class="form-control" onblur="isnull('staffPhone','warnNumber')">
                            <p></p>
                            <p id="warnNumber" style="color: #ff0000"></p>
                            <p id="error"> </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-9 col-sm-offset-3">
                        <input class="btn btn-primary" value="Submit" onclick="checkEmployee()" />
    ...
    function ajax(){
        $.ajax({
            ...
            success:function () {
                ...
                else window.document.getElementById("error").innerText="";
            },
            error:function (){
                alert("error");
...
<script>
    function checkEmployee(){
        if(staffName.value==""||staffAge.value==""||staffSex.value==""||staffPhone.value==""){
