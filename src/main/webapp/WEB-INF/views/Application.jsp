...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-user"></i>Application</h2>
      <div class="breadcrumb-wrapper">
        <span class="label">You are here:</span>
        <ol class="breadcrumb">
          <li><a href="/application">Application</a></li>
          <li class="active">Users Controls</li>
    ...
    <div class="panel-body panel-body-nopadding">
          ...
          <form class="form-horizontal form-bordered" id="application-inf">


 <!--Reason for Application--> 
                  <div class="form-group">
                  <label class="col-sm-3 control-label">Reason For Application<span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                  	<textarea style="width: 360px" id="reason" rows="3" class="form-control" placeholder="Please enter the project content" onblur="isnull('reason','warnReason')"></textarea>
                    <p></p>
                    <p id="warnReason" style="color: #ff0000"></p>
                  </div>
                </div>          
<!--Request for Access-->
  <div class="form-group">

                  <label class="col-sm-3 control-label">Application
                  <span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                  <select type="text" name="application" id="application" onblur="isnull('application','warnprojectType')">
                      <option value=""> </option>
  ...
  <div class="panel-body">
                <div class="row">
                  <div class="col-sm-9 col-sm-offset-3">
                     <input type="button" class="btn btn-primary" onclick="check()" value="Insert">
 ...
 function ajax(){
    $.ajax({
            ...
            success:function (result) {
                ...
                else window.document.getElementById("error").innerText="success";
            },
            error:function (){
              alert("error");
...
<script>
function check(){
  if(reason.value===""||application.value===""){
